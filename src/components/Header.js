        ...
        <Container>
          <Toolbar>
            ...
            <Select
              ...
              value={currency}
              style={{ width: 100, height: 40, marginLeft: 15, color: "#16f5f1", fontWeight: "bold" }}
              onChange={(e) => setCurrency(e.target.value)}
            >
              <MenuItem style={{color: "#16f5f1", fontWeight: "bold" }} value={"USD"}>USD</MenuItem>
              <MenuItem style={{color: "#16f5f1", fontWeight: "bold"}} value={"INR"}>INR</MenuItem>
            </Select>
